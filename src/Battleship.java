...
public class Battleship {
    ...
    public static void main(String[] args) {
        ...
        Board player1Board = player1.placeShips();

        System.out.println();
        System.out.println();
        System.out.println("Second player, enter coordinates of where you want to place your 5 ships.");
        System.out.println("For example: the number 13 represents row 1 column 3.");
        board.printBoard();

        Board player2Board = player2.placeShips();

        while(!gameOver){
            player1.takeTurn(player1Board,player2Board);
        }
